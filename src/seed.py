...
def seed_database():
    with app.app_context():
        ...
        for sub_name, cat_name in subcategories_data:
            sub = Subcategory(name=sub_name, category_id=categories[cat_name].id)
            db.session.add(sub)
        ...
        providers_seed = [
            ...
            },
            {
                ...
                "schedule": [{"day": 6, "start": time(8,0), "end": time(20,0)}, {"day": 7, "start": time(8,0), "end": time(20,0)}], # Fin de semana
        ...
        covers = [
            ...
            "https://res.cloudinary.com/demo/image/upload/v1610000000/medical_cover.jpg",
            "https://res.cloudinary.com/demo/image/upload/v1620000000/scooter_cover.jpg"
        ]
        profiles = [
            "https://res.cloudinary.com/demo/image/upload/w_200,h_200,c_fill,r_max/face_top.jpg",
            "https://res.cloudinary.com/demo/image/upload/w_200,h_200,c_fill,r_max/doctor_profile.jpg",
            "https://res.cloudinary.com/demo/image/upload/w_200,h_200,c_fill,r_max/courier_profile.jpg"
        ]
